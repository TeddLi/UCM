...
PYTHONPATH=${PKG_DIR}:$PYTHONPATH CUDA_VISIBLE_DEVICES=1python -u ${PKG_DIR}/model/train_UCM.py \
		...
		--evaluate_every $evaluate_every > log_reproduce_weight11_att1.txt 2>&1 &
