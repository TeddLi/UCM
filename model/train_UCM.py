...
# Files
tf.flags.DEFINE_string("train_file", "../data/Advising_dstc_valid.txt", "path to train file")
tf.flags.DEFINE_string("valid_file", "../data/Advising_dstc_valid.txt", "path to valid file")
tf.flags.DEFINE_string("test_file", "../data/Advising_dstc_test.txt", "vocabulary file")
tf.flags.DEFINE_string("vocab_file", "../data/vocab.txt", "vocabulary file")
tf.flags.DEFINE_string("char_vocab_file",  "../data/char_vocab.txt", "path to char vocab file")
tf.flags.DEFINE_string("embedded_vector_file", "../data/glove_840B_300d_vec_plus_word2vec_100.txt", "pre-trained embedded word vector")
tf.flags.DEFINE_string('model_name',help=('model_name'), default = 'UCM')
...
tf.flags.DEFINE_integer("seeds", 234, "random seeds")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        def train_step(x_utterances, x_utterances_len, x_utterances_num, x_utterances_char, x_utterances_char_len, x_target, x_id, x_target_weight, dialogue_label):
            """
        ...
        for batch in batches:
            ...
            train_step(x_utterances, x_utterances_len, x_utterances_num, x_utterances_char, x_utterances_char_len, x_target, x_id, x_target_weight, dialogue_label)
